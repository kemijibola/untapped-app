...
@Component({
  selector: "app-add-more-audio",
  templateUrl: "./add-more-audio.component.html",
  styleUrls: ["./add-more-audio.component.css"],
})
export class AddMoreAudioComponent implements OnInit {
  @Input() audioAlbumId: string = "";
  uploadComponent = UPLOADCOMPONENT.portfolio;
  uploadAction = UPLOADACTION.updateaudioalbum;
