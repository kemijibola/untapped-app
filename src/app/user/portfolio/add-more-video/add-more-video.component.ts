...
@Component({
  selector: "app-add-more-video",
  templateUrl: "./add-more-video.component.html",
  styleUrls: ["./add-more-video.component.css"],
})
export class AddMoreVideoComponent implements OnInit {
  @Input() videoAlbumId: string = "";
  uploadComponent = UPLOADCOMPONENT.portfolio;
  uploadAction = UPLOADACTION.updatevideoalbum;
